...
alias dir='eza -l --no-permissions --no-user \
  --time-style=relative --sort=modified -r --only-dirs'

alias vdir='eza -l --header \
  --time-style=long-iso --only-dirs --sort=modified -r'
...
alias val='vim ~/.config/zsh/aliases.zsh'
